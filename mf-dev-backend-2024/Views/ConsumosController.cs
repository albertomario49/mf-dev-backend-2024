...
namespace mf_dev_backend_2024.Views
{
    public class ConsumosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Descrição,Data,Valor,Km,Tipo,VeiculoId")] Consumo consumo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descrição,Data,Valor,Km,Tipo,VeiculoId")] Consumo consumo)
        {
            if (id != consumo.Id)
            {
                return NotFound();
